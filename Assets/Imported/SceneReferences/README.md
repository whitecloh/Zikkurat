...
_I am leaving this gist up for reference, but will no longer update code here. The code is now being maintained in a [Dedicated Github Repo](https://github.com/starikcetin/unity-scene-reference) - special thanks for [starikcetin](https://github.com/starikcetin) for taking initiative there._

_If you have any suggested improvements or bugs to report, please [file an issue there](https://github.com/starikcetin/unity-scene-reference/issues)_.
